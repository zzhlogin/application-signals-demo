...
public class ApiController {
    ...
    @PutMapping("customer/diagnose/owners/{ownerId}/pets/{petId}")
    public Mono<Void> diagnosePet(final @PathVariable int ownerId, final @PathVariable int petId, @RequestBody PetRequest petRequest) {
